# Generated by Django 5.2 on 2026-01-06 20:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('general', 'Общий чат'), ('physics', 'Физика'), ('algebra', 'Алгебра'), ('geometry', 'Геометрия'), ('private', 'Приватный')], default='general', max_length=20)),
